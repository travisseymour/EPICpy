...
//include "/home/nogard/Dropbox/Documents/EPICSTUFF/EPIC_CLI_WORK_EPIC2016/EPICLib/Model-View Classes/View_base.h"
//include "/home/nogard/Dropbox/Documents/EPICSTUFF/EPIC_CLI_WORK_EPIC2016/EPICLib/Utility Classes/Assert_throw.h"
...
public:
	...
	bool output_enabled()
      ...
      // DISABLED -- Using Locally defined stuff to avoid this (i.e., Normal_out_write...)
//    // templated member function applies for any type being output
//    // TLS2021: not super easy to use << in Python with cppyy, so I
//    //          need an easy way to send text to an Output_tee.
//    //          This is just a copy of the function below (<<) with a new name.
