...
#include "../PPS Interface classes/PPS_globals.h"
#include "../../Utility Classes/Symbol.h"
#include "../../Utility Classes/Symbol_utilities.h"
#include "../Variables and Bindings/Variables.h"
#include "../Variables and Bindings/Binding_set.h"
#include "../Variables and Bindings/Binding_set_list.h"
#include "Combining_Nodes.h"
#include "Predicate.h"
//#include "Command_Action.h"
#include "../../Motor Classes/Motor_action.h"
...
public:
	Simple_Rule_Node(Production_System * in_production_system_ptr, int in_id, const Symbol& in_rule_name, Combining_Node * in_input,
			const list_Symbol_list_t& add_action_list, const list_Symbol_list_t& delete_action_list, const list_Symbol_list_t& command_action_list) :
		Combining_Node(in_id), Rule_Node (in_production_system_ptr, in_rule_name, in_input, add_action_list, delete_action_list, command_action_list)
		{}
...
public:
	Bindings_Rule_Node(Production_System * in_production_system_ptr, int in_id, const Symbol& in_rule_name, Combining_Node * in_input,
			const list_Symbol_list_t& add_action_list, const list_Symbol_list_t& delete_action_list, const list_Symbol_list_t& command_action_list) :
		Bindings_Node(in_id), Rule_Node (in_production_system_ptr, in_rule_name, in_input, add_action_list, delete_action_list, command_action_list)
		{}
...
public:
	Bindings_Predicate_Rule_Node(Production_System * in_production_system_ptr, int in_id, const Symbol& in_rule_name, 
		...
		command_action_list), predicate_ptrs(in_predicate_ptrs)
		{}
