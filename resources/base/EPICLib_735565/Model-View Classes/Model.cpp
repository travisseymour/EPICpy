...
#include "../Framework classes/Human_processor.h"
#include "../Framework classes/Device_processor.h"
#include "../Framework classes/Device_base.h"
...
#include "../Utility Classes/Exception.h"
...

{
	...
	cout << "mama: about to make human_ptr" << endl;
	human_ptr = new Human_processor("Human1");
	cout << "mama: done making human_ptr" << endl;
...
//{
//	Assert(human_ptr);
//	return human_ptr->set_auditory_encoder_ptr(auditory_encoder_ptr);
//}
