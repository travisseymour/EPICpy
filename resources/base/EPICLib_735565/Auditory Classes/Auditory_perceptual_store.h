...
//		{return new Auditory_perceptual_sound(sound_name, stream_name, time_stamp, timbre, Symbol(), Symbol(), Symbol(), loudness, duration, intrinsic_duration);}
		{return new Auditory_perceptual_sound(sound_name, stream_name, time_stamp, location, timbre, Symbol(), Symbol(), Symbol(), loudness, 0., duration, intrinsic_duration);}
	// fatter interface for speech sounds
	static Smart_Pointer<Auditory_sound> create(const Symbol& sound_name, const Symbol& stream_name, long time_stamp, GU::Point location,
		const Symbol& timbre, 
		const Symbol& content, const Symbol& gender, const Symbol& speaker_id,
...
//			{return new Auditory_perceptual_sound(sound_name, stream_name, time_stamp, timbre, content, gender, speaker_id, loudness, duration, intrinsic_duration);}
			{return new Auditory_perceptual_sound(sound_name, stream_name, time_stamp, location, timbre, content, gender, speaker_id, loudness, pitch, duration, intrinsic_duration);}
...
private:
	Auditory_perceptual_sound(const Symbol& sound_name, const Symbol& stream_name,  long time_stamp, GU::Point location,
		...
		double loudness, double pitch, long duration, long intrinsic_duration) :
//		Auditory_sound(sound_name, stream_name, time_stamp, timbre, content, speaker_gender, speaker_id, loudness, duration, intrinsic_duration), 
		Auditory_sound(sound_name, stream_name, time_stamp, location, timbre, content, speaker_gender, speaker_id, loudness, pitch,duration, intrinsic_duration), 
	...
	Auditory_perceptual_sound(const Auditory_perceptual_sound&);
	Auditory_perceptual_sound& operator= (const Auditory_perceptual_sound&);
...
//	virtual void accept_event(const Stop_event *);
	...
	Smart_Pointer<Auditory_perceptual_sound> get_perceptual_object_ptr(const Symbol& name);
	void lose_stream_from_memory(Smart_Pointer<Auditory_stream> obj_ptr);
	void lose_sound_from_memory(Smart_Pointer<Auditory_perceptual_sound> obj_ptr);
