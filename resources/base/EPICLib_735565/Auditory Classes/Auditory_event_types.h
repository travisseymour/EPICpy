...
#include "../Framework classes/Event_types.h"
...
public:
/*	Auditory_Speech_Start_event(long t, Processor * r, const Symbol& sound_name_, const Symbol& stream_,  long time_stamp_, 
		const Symbol& content_, const Symbol& speaker_gender_, const Symbol& speaker_id_,
		double loudness_, long duration_) : 
		Auditory_event(t, r), sound_name(sound_name_), stream_name(stream_), time_stamp(time_stamp_), content(content_), 
