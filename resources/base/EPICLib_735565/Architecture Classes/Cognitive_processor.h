...
#include "../PPS/PPS Interface classes/Production_System.h"
#include "../PPS/PPS Interface classes/Command_interface.h"
...
public:
	Cognitive_processor(Human_processor * human_ptr_) :
		...
		cycle_time("Cycle_time", 50), ready_to_run(false), command_interface(human_ptr_)
		{
...
private:
	...
	Cognitive_processor(const Cognitive_processor&);
	Cognitive_processor& operator= (const Cognitive_processor&);
