...
class Visual_store_object : public Reference_Counted_Object {
public:
	virtual ~Visual_store_object()
		{}
	static Smart_Pointer<Visual_store_object> create(const Symbol& name,  GU::Point location, GU::Size size)
				{return new Visual_store_object(name, location, size);}
...
inline bool operator< (Smart_Pointer<Visual_store_object> lhs, Smart_Pointer<Visual_store_object> rhs)
...
public:
	...
	Smart_Pointer<Visual_store_object> get_object_ptr(const Symbol& name) const;
	...
	typedef std::list<Smart_Pointer<Visual_store_object> > Store_object_ptr_list_t;
...
protected:	
	...
	typedef std::map<Symbol, Smart_Pointer<Visual_store_object> > Store_container_t;
	...
	void insert_new(Smart_Pointer<Visual_store_object> obj_ptr);
	// erase the specified object,throw an exception if not present
	void erase(const Symbol& name);
	// erase the specified object,throw an exception if not present
	void erase(Smart_Pointer<Visual_store_object> obj_ptr);
	// empty the contents
	void clear();
