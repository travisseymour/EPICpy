...
public:
	static Smart_Pointer<Visual_store_object> create(const Symbol& physical_name_, GU::Point location_, GU::Size size_)
			{return new Visual_physical_object(physical_name_, location_, size_);}
