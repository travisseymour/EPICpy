...
class Ui_DialogDisplayControls(object):
    def setupUi(self, DialogDisplayControls):
        ...
        DialogDisplayControls.resize(679, 360)
        ...
        self.horizontalSpacer_2 = QSpacerItem(
            28, 17, QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Minimum
        )
        ...
        self.checkBoxShowFullTraceback = QCheckBox(DialogDisplayControls)
        self.checkBoxShowFullTraceback.setObjectName("checkBoxShowFullTraceback")

        self.verticalLayout_3.addWidget(self.checkBoxShowFullTraceback)
    ...
    def retranslateUi(self, DialogDisplayControls):
        DialogDisplayControls.setWindowTitle(
            QCoreApplication.translate("DialogDisplayControls", "Display Controls", None)
        )
        self.checkBoxPPSMemoryContents.setText(
            QCoreApplication.translate("DialogDisplayControls", "PPS Memory Contents", None)
        )
        self.checkBoxPPSRunMessages.setText(
            QCoreApplication.translate("DialogDisplayControls", "PPS Run Messages", None)
        )
        self.checkBoxPPSCompilerMessages.setText(
            QCoreApplication.translate("DialogDisplayControls", "PPS Compiler Messages", None)
        )
        self.spinBoxSpatialScale.setSuffix("")
        self.label.setText(
            QCoreApplication.translate("DialogDisplayControls", "Spatial scale pixels/degree", None)
        )
        self.checkBoxCompilerDetails.setText(
            QCoreApplication.translate("DialogDisplayControls", "Compiler Details", None)
        )
        ...
        self.checkBoxCalibrationGrid.setText(
            QCoreApplication.translate("DialogDisplayControls", "Calibration Grid", None)
        )
        ...
        self.checkBoxShowFullTraceback.setText(
            QCoreApplication.translate(
                "DialogDisplayControls",
                "If a runtime exception occurs during simulation, show full traceback?",
                None,
            )
        )
        ...
        self.pushButtonOK.setText(QCoreApplication.translate("DialogDisplayControls", "OK", None))
