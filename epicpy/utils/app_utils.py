...
def check_int(value) -> bool:
    ...
    Replacement for fastnumbers.check_int.
    """
...
# Re-export from param_utils for backward compatibility
from epicpy.utils.param_utils import unpack_param_string  # noqa: F401
