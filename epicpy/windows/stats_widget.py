...
from qtpy.QtGui import QCloseEvent, QImage, QTextDocument
...
class CustomStatsTextBrowser(QTextBrowser):
    ...
    def contextMenuEvent(self, event):
        ...
        if self._has_image:
            ...
            action = menu.exec_(event.globalPosition().toPoint())
...
class StatsWidget(QWidget):
    ...
    def export_contents(self, parent=None) -> None:
        ...
        export_html = f"<html><head><meta charset='utf-8'><title>EPICpy Stats Export {time.ctime()}</title></head><body>"
