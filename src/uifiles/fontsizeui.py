...
class Ui_DialogFontSize(object):
    ...
    def retranslateUi(self, DialogFontSize):
        ...
        self.label_3.setText(_translate("DialogFontSize", "<html><head/><body><p><span style=\" font-size:20pt; font-weight:600;\">Application Font Name: Consolas</span></p></body></html>"))
