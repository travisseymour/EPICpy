...
#include "../Auditory Classes/Auditory_store.h"
...
{
	return perceptual_proc_ptr->get_parameter_ptr(parameter_name)->get_value();
}
...
{
	Smart_Pointer<Auditory_sound> obj_ptr = perceptual_proc_ptr->get_sensory_object_ptr(object_name);
