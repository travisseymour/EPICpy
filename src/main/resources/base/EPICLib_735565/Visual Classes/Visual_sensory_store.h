...
public:
	static Smart_Pointer<Visual_store_object> create(const Symbol& psychological_name_, GU::Point location_, GU::Size size_)
				{return new Visual_sensory_object(psychological_name_, location_, size_);}
