...
#include "../Framework classes/Processor.h"
...
class Motor_action : public Reference_Counted_Object {
public:
	...
	static Smart_Pointer<Motor_action> create(Human_processor *, Symbol_list_t);
