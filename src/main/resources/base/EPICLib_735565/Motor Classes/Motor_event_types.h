...
class Motor_Command_Action_event : public Motor_event {
public:
	Motor_Command_Action_event(long t, Processor * d, Smart_Pointer<Motor_action> a) :
		Motor_event(t, d) , action(a) {}
	virtual void handle_self(Motor_processor *) const;
	
	Smart_Pointer<Motor_action> action;
};
