...
public:
    ...
    void add_sound(Smart_Pointer<Auditory_sound> sound_ptr);
	...
	virtual void set_theta(double lambda_) {};
	virtual void set_alpha(double lambda_) {};
...
protected:
    ...
    std::vector<Smart_Pointer<Auditory_sound>> sounds;
