...
void Auditory_sensory_store::handle_event(const Auditory_Stream_Destroy_event * event_ptr)
{
	...
	schedule_event(new Auditory_Stream_Erase_event(get_time() + disappearance_decay_delay.get_value(), 
...
void Auditory_sensory_store::handle_event(const Auditory_Sound_Stop_event * event_ptr)
{
	...
	schedule_event(new Auditory_Sound_Erase_event(get_time() + disappearance_decay_delay.get_value(), 
